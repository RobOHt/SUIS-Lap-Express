...
class CarEnv:
    ...
    # MODEL_NAME = input("Which AI model would you like this car to apply? ")
    MODEL_NAME = "MODELalexnetv2EPOCHS7"
    ...
    def reset(self):
        ...
        for i in range(6):
            ...
            if 6 - i == 5:
                ...
                print(text)
                self.vehicle.apply_control(carla.VehicleControl(throttle=0.38, steer=0.0))
            time.sleep(1)
    ...
    def record_data(self, image):
        ...
        # ------------------------------------------------------------------------Apply control
        prediction = predict_model(igray, self.MODEL_NAME)  # MODEL_NAME = MODELalexnetv2EPOCHS7
        # print(prediction)
